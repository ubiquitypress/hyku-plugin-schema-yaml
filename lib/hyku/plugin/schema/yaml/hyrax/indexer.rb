    ...
    module Schema
      module Yaml
        module Hyrax
          ...
          #
          # @since 3.0.0
          def self.Indexer(schema_name, index_loader: Hyku::Plugin::Schema::Yaml::Hyrax::SimpleSchemaLoader.new)
            Hyku::Plugin::Schema::Yaml::Hyrax::Indexer.new(index_loader.index_rules_for(schema: schema_name))
          end
