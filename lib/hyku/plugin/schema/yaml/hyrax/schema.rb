      ...
      module Yaml
        module Hyrax
          ...
          def self.Schema(schema_name, **options)
            Hyku::Plugin::Schema::Yaml::Hyrax::Schema.new(schema_name, **options)
          end
          ...
          class Schema < Module
            ...
            #
            # @api private
            def initialize(schema_name, schema_loader: Hyku::Plugin::Schema::Yaml::Hyrax::SimpleSchemaLoader.new)
              @name = schema_name
